...
export const UserList = ({
    ...
    const [selectedAdd, setSelectedAddUser] = useState(false)

    const onAddClick = async () => {
        setSelectedAddUser(true);
    };
    const onClickedAdd = async (ev) => {
        onCreate(ev)
    ...
    const onDeleteClick = async (userId) => {
        ...
        setSelectedDeleteUser(userId);
    };
    const onDeletedClick = async (userId) => {
        await onDelete(userId)
        setSelectedDeleteUser(false);
    };
